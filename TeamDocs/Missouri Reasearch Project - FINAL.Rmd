...
## Change in Yearly Discharge Variations over Years

```{r varfig, echo=FALSE, warning=FALSE, out.width="\\maxwidth", fig.cap="\\label{fig:varfig}Changes in the standard deviations of discharge within a year at 22 sites over the whole time span of available data."}
knitr::include_graphics('../Figures/sd_year.png')
```


```{r vartab, echo=FALSE, eval=TRUE, caption="\\label{tab:vartab}",results="asis"}
