...
- The daily values dataset containing discharge, nitrogen, and phosphorus data for 22 sites. Following is an example of daily values from site No. 22 Missouri River At Hermann, MO (\autoref{fig:dataexample}):

```{r datawxample, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:dataexample} Discharge, Nitrogen, Phosphorus daily data of site No. 22 Missouri River At Hermann, MO."}
knitr::opts_chunk$set(message=FALSE, warning=FALSE, echo=FALSE, fig.height = 8, 
                      fig.width = 10)
## Discharge
...
Time | UTC | 22
Nitrogen | mg/L | 22 daily values, 6 high frequency
Phosphorus | mg/L | 22
...
Dismal River near Thedford, Nebr.
