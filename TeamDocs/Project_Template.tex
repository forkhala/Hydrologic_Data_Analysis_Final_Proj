...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#linear model for TN }
\NormalTok{tn.mod <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ bestsites.wq.skinny, total.nitrogen }\OperatorTok{~}\StringTok{ }\NormalTok{Date)}
\KeywordTok{summary}\NormalTok{(tn.mod) }\CommentTok{#for every day increase, total nitrogen increases by 9.310e-05 mg/l. Thus there is a significant increase over the time period (p < 2e-16, F-statistic = 23.31).}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#linear model of total coliform over time}
\NormalTok{tc.mod <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ bestsites.wq.skinny, total.coliform }\OperatorTok{~}\StringTok{ }\NormalTok{Date)}
\KeywordTok{summary}\NormalTok{(tc.mod) }\CommentTok{#for every day increase, total coliform increases by 1.046 cfu/100 ml. Thus, there is an increase over the time period (p < 0.0138, F-statistic = 0.01576).}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#linear model of total phosphorus over time with just 6 sites that have total coliform}
\NormalTok{tp.mod <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ bestsites.wq.skinny, total.phosphorus }\OperatorTok{~}\StringTok{ }\NormalTok{Date)}
\KeywordTok{summary}\NormalTok{(tp.mod) }\CommentTok{#for every day increase, total phosphorus increases by 1.887e-05 mg/L. Thus, there is a significant increase in total phosphorus over the time period (p < 2.14e-15, F-statistic = 30.92).}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#pH model}
\NormalTok{ph.mod <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ bestsites.wq.skinny, pH }\OperatorTok{~}\StringTok{ }\NormalTok{Date)}
\KeywordTok{summary}\NormalTok{(ph.mod) }\CommentTok{#for every day increase}
\end{Highlighting}
\end{Shaded}
