...
2. What factors contribute to the variability of total nitrogen in the rivers?
...
highfreqsites2019 <- read.csv("./Data/Raw/highfreqsite2019.csv", as.is=TRUE)
highfreqsites2019 <- highfreqsites2019 %>% select(-X)

#individual sites
Hermann <- highfreqsites2019 %>%
           filter(site_no=="06934500")
Desoto <- highfreqsites2019 %>%
          filter(site_no=="06892350")
Clarinda <- highfreqsites2019 %>%
            filter(site_no=="06817000")
Randolph <- highfreqsites2019 %>%
