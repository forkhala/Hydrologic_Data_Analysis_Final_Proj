...
\hypertarget{change-in-yearly-discharge-variations-over-years}{%
\subsection{Change in Yearly Discharge Variations over
Years}\label{change-in-yearly-discharge-variations-over-years}}

\begin{figure}
\includegraphics[width=\maxwidth]{../Figures/sd_year} \caption{\label{fig:varfig}Changes in the standard deviations of discharge within a year at 22 sites over the whole time span of available data.}\label{fig:varfig}
\end{figure}
