...
```{r dischargepre, echo=FALSE, fig.cap="\\label{fig:dischargepre}Historic and 10-year prediction of discharge at Site No. 22, the  Missouri River At Hermann, MO. (Solid Line: Historic Measurement of Discharge; Dash Line: 10-year Prediction of Discharge)"}
...
## Discharge Pattern and Variation
In this project, we showed that most rivers and streams in the Missouri River Basin have higher discharge as well as larger variation during the summer than the winter. A few rivers that originate from aquifer or groundwater display more stable discharge pattern throughout a year.
...
## Droughts
From the drought analysis of the 6 tributaries and rivers, it is evident that minimum discharge amounts vary greatly (range: 1.47 cfs – 12414) (Table 6). We predicted that discharge would decrease during periods of drought, and it does, but the 7-day minimum average flow clearly varies among sites. Although the analysis shows that droughts decrease flow, it is difficult to compare droughts and flow between the sites because the rivers are of different sizes and magnitudes, and thus discharge amounts vary greatly. For example, three sites were analyzed that are located on the Missouri River, which is much larger than some of the tributaries that were analyzed. Thus, the discharge patterns are not able to be compared because of the difference in sizes. If we were to do this analysis again, we would likely choose not located on the Missouri River and compare them, or choose only sites that are on the Missouri River to have a better comparison. 

## Trends of the Concentration of Nitrogen and Phosphorus
From the analysis of long-term daily nitrogen and phosphorus data, we see a significant increasing trend of nitrogen and phosphorus at the mainstem of the Missouri River. Corresponding, from the linear model we created, we can also see that the concentration of nitrogen will increase with the concentration of phosphorus and year, with indicates that the trends of the Concentration of Nitrogen and Phosphorus are increasing. Water quality in the Missouri River is still deteriorating and protection is urgently needed.

## Discharge Trends Analysis and Discharge Prediction
From the dicharge trends analysis, out of all 22 sites, only 4 sites that locate in HUC 1025 and 1026, away from the main stem of the Missouri River show decreasing trends of discharge. Overall, the discharge in Missouri River is increasing.

In addition, we employed Autoregressive and Moving Average Models (ARMA) to forecast the discharge at all 22 sites into the future. Due to that only the first few years of discharge simulation is reasonable from the ARMA, we only made one-year prediction of discharge for every site.
