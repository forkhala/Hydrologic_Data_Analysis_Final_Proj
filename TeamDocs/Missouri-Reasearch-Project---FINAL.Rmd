...
In order to better understand what contributes to the variability of nitrogen concentration in our study area of interest, we created a linear model with fixed effects. By considering the huc4 region each site is in as a fixed effect, we can estimate the amount of variation of nitrogen between each huc4. 
