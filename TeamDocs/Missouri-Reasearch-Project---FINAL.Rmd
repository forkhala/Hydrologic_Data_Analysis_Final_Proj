...
```{r Randolphstorm, echo=FALSE, fig.cap="\\label{fig:Randolphstorm}Hyteresis plot for site number 9 in Randolph, IA that shows a negative slope (diluting behavior) in a counter clockwise direction."}
